...
def generate_i2i(
    ...
    *,
    ...
    uncon_text_start: Optional[int] = None,
    uncon_img_start: Optional[int] = None,
    ...
    for step in range(timesteps):
        ...
        if cfg_scale > 0 or cfg_img > 0:
            ...
            uncond_logits_text_raw = model(uncond_text, infer=True).logits
            uncond_logits_text = uncond_logits_text_raw[:, uncond_text_vq_mask[0],
            ...
            uncond_logits_img_raw = model(uncond_img, infer=True).logits
            uncond_logits_img = uncond_logits_img_raw[:, uncond_img_vq_mask[0], vocab_offset : vocab_offset + codebook_size]
